...
namespace boost
{
    ...
    namespace detail // lcast_src_length
    {
        ...
        struct lcast_src_length_integral
        {
            ...
            BOOST_STATIC_CONSTANT(std::size_t, value = std::numeric_limits<Source>::is_signed + std::numeric_limits<Source>::is_specialized + std::numeric_limits<Source>::digits10 * 2
              );
#else
